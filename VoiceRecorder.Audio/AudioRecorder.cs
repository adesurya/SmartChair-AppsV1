...
namespace VoiceRecorder.Audio
{
    public class AudioRecorder : IAudioRecorder
    {
        ...
        public UnsignedMixerControl volumeControl;
        ...
        public void BeginMonitoring(int recordingDevice)
        {
            ...
            waveIn.WaveFormat = new NAudio.Wave.WaveFormat(44100, NAudio.Wave.WaveIn.GetCapabilities(recordingDevice).Channels);
            
            //NAudio.Wave.WaveInProvider waveInn = new NAudio.Wave.WaveInProvider(waveIn);
            //waveOut = new NAudio.Wave.DirectSoundOut();
            //waveOut.Init(waveInn);
